...
SELECT 23,'NC',ROW_NUMBER()OVER ( ORDER BY P.NIT)+15309,P.NIT,'05/04/2016',0,'05/04/2016',P.VALOR,0,0,0,0,0,0,0,0,0,T.vendedor,0,0,27,'',
...
SELECT DL.nit,ROUND(SUM((DL.valor_unitario-R.valor_unitario)*DL.cantidad),0) VALOR
