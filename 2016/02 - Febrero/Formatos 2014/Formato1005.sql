...
ROUND(SUM(Q.SALDOFINAL),0,0) SALDOFINAL, SUM (Q.DEVOLUCION) DEVOLUCION
FROM (
SELECT 
...
(CV.cuenta LIKE '240810%' OR CV.cuenta LIKE '240825%' OR CV.cuenta LIKE '240899%'))
AS P 
WHERE P.SALDOFINAL>100000
