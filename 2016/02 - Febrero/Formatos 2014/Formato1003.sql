...
ROUND(SUM(Q.SALDOFINAL),0,0) SALDOFINAL
FROM (
SELECT C.CONCEPTO,
...
FROM (
SELECT 
CASE WHEN CV.cuenta IN ('13551501') THEN 1302 
	WHEN CV.cuenta IN ('13551503') THEN 1303 
	WHEN CV.cuenta IN ('13551504')  THEN 1306 
	WHEN CV.cuenta IN ('13551505','13551507','13551508')  THEN 1307 ELSE 0 END  CONCEPTO,
...
CASE WHEN (CV.saldo_inicial + CV.debito - CV.credito)<0 THEN (CV.saldo_inicial + CV.debito - CV.credito)*-1 ELSE (CV.saldo_inicial + CV.debito - CV.credito) END SALDOFINAL
...
CV.cuenta in ('13551501','13551503','13551504','13551505','13551507','13551508'))
AS P 
