...
CASE WHEN ROUND(SUM(Q.SALDOFINAL),0,0)<0 THEN ROUND(SUM(Q.SALDOFINAL),0,0) ELSE ROUND(SUM(Q.SALDOFINAL),0,0) END SALDOFINAL, SUM (Q.DEVOLUCION) DEVOLUCION
FROM (
SELECT 
