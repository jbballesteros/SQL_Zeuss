...
ISNULL(TM.cta1,TM2.cta1) CUENTA,198,ZL.nit,(ZL.cantidad*ZL.costo_unitario)*-1 VALOR,'ZINV IMPUESTO NACIONAL TRASLADO'
...
WHERE YEAR(ZL.fec)=2016 and MONTH(ZL.fec)=6 AND R.subgrupo2 IN (13,20,21)  AND D.sw=11
