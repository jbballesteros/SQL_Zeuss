...
SELECT S.CONCEPTO,TM.TIPO,ISNULL(TM.NIT,S.NIT) NIT,TM.DIGITO,TM.PAPELLIDO,TM.SAPELLIDO,TM.PNOMBRE,TM.SNOMBRE,TM.RAZON_SOCIAL,TM.DEPARTAMENTO,TM.CIUDAD,PAIS,SUM(S.VALOR) VALOR, RM.CREDITO RETENCION,RM.RETE_INVA,RM.NO_DEDUC ,RM.IVA_MAY,
...
LEFT JOIN zeuss.dbo.retencion_medios RM ON (S.NIT=RM.NIT)
GROUP BY S.CONCEPTO,S.NIT,TM.TIPO,TM.NIT,TM.DIGITO,TM.PAPELLIDO,TM.SAPELLIDO,TM.PNOMBRE,TM.SNOMBRE,TM.RAZON_SOCIAL,TM.DEPARTAMENTO,TM.CIUDAD,PAIS,TM.DIRECCION,TM.CIUDAD,TM.DEPARTAMENTO,RM.CREDITO ,RM.RETE_INVA,RM.NO_DEDUC ,RM.IVA_MAY
) AS D
) AS E
