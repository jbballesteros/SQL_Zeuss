...
SELECT 14, 'SCP', ROW_NUMBER() OVER (ORDER BY D.NUMERO)+2319, D.nit, D.fecha, D.condicion, D.vencimiento,0, D.iva, D.retencion, D.retencion_causada, D.retencion_iva, D.retencion_ica, D.descuento_pie, D.fletes, D.iva_fletes, 
...
WHERE D.fecha BETWEEN '01/05/2016' AND '31/05/2016' AND D.sw IN (11,12) AND concepto=7 AND DL.adicional LIKE '%BODO:1000%' AND D.bodega=1
